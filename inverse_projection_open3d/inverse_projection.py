...
from utils import load_depth_png, load_image, Calibration
...
if __name__ == "__main__":
    ...
    lidar_path = "../dataset/kitti/raw_data/2011_09_28/2011_09_28_drive_0106_sync/velodyne_points/data/"
    ...
    lidar_list = [lidar_path + '%010d.bin' % (i) for i in range(5, 70)] 
